...
export interface AdminState {
	action: 'adding_channel' | 'adding_source' | 'removing_channel' | 'downloading_media' | 'setting_format_custom' | 'setting_telegraph_token' | 'setting_ai_model' | 'setting_ai_prompt' | 'testing_ai_summary';
	context?: {
		channelId?: string;
		sourceId?: string;
