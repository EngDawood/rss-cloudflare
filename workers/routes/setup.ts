...
export const BOT_COMMANDS = [
	...
	{ command: 'addchat', description: 'Add/update a named chat: /addchat name @user' },
	{ command: 'rmchat', description: 'Remove a named chat' },
	{ command: 'defaultchat', description: 'Set the default named chat' },
	...
	{ command: 'folo', description: 'Configure Folo webhook integrations' },
